...
class PDF(FPDF):
    ...
    def listaTodos(self):
        ...
        pdf.cell(50, 5, 'CPF', 0, 1, 'L')
        pdf.cell(50, 5, 'Telefone', 0, 1, 'L')
        pdf.cell(50, 5, 'Grupo', 0, 1, 'L')
        pdf.cell(50, 5, 'Senha', 0, 1, 'L')
        ...
        pdf.output('scr/pdfFuncionario.pdf')